...
public interface StarRepository extends JpaRepository<StarEntity, Integer> {
  ...
  Page<StarEntity> findByProductIdAndFiveStar(
      Integer productId,
      Integer fiveStar,
      Pageable pageable);

  Page<StarEntity> findByProductIdAndFiveStarIsNotNullAndFeedbackIsNotNull(
      Integer productId,
      Pageable pageable);
  ...
  @Query("""
      ...
      WHERE s.productId = :productId
        ...
        AND (
              s.imgOne IS NOT NULL
           OR s.imgTwo IS NOT NULL
           OR s.imgThree IS NOT NULL
        )
      """)
  Page<StarEntity> findProductReviewsWithImage(
  ...
  @Query("""
      ...
      WHERE s.productId = :productId
        ...
        AND TRIM(s.feedback) <> ''
      """)
  Page<StarEntity> findProductReviewsWithFeedback(
      @Param("productId") Integer productId,
      Pageable pageable);
}
