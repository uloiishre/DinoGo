...
| `password` | 是 | 至少 8 字元、最多 72 個 UTF-8 位元組 |
| `confirmPassword` | 是 | 至少 8 字元、最多 72 個 UTF-8 位元組，且必須與 `password` 相同 |
| `lastName` | 是 | 最長 50 字 |
| `firstName` | 是 | 最長 50 字 |
...
| `newPassword` | 是 | 至少 8 字元、最多 72 個 UTF-8 位元組。 |
| `confirmNewPassword` | 是 | 至少 8 字元、最多 72 個 UTF-8 位元組，且必須與 `newPassword` 相同。 |
